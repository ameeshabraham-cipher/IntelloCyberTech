...
The website was developed using React with TypeScript for a modern, interactive user experience. It uses Express.js for the backend API support.
...
This will start the Express server and the React development server concurrently.
