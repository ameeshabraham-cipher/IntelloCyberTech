...
const Iso27001Page = () => {
  ...
  const serviceSchema = {
    name: "ISO 27001 Certification and Implementation Services in UAE",
    description: "Expert ISO 27001 implementation & certification services in UAE. Get compliant with international information security standards with our end-to-end consulting services.",
    provider: {
      "@type": "Organization",
      name: "Intello Cyber Technologies"
    },
    serviceType: "Information Security Consultancy",
    areaServed: {
      "@type": "Country",
    ...
    audience: {
      ...
      audienceType: "Organizations seeking information security certification"
    }
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="ISO 27001 Certification & Implementation in UAE"
        category="GRC Services"
        description="Achieve ISO 27001 certification with our comprehensive implementation and advisory services. Our UAE-based experts guide you through gap assessment, controls implementation, documentation, and certification audit."
