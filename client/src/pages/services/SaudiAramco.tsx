...
const SaudiAramcoPage = () => {
  return (
    <ServicePageLayout
      ...
      description="Achieve compliance with Saudi Aramco's cybersecurity requirements through our comprehensive assessment and implementation services tailored for vendors, suppliers, and partners working with Saudi Aramco."
      heroIcon={<Building className="h-8 w-8" />}
      overview="Saudi Aramco maintains strict cybersecurity requirements for its suppliers, vendors, and partners to protect its critical infrastructure and sensitive data. Our Saudi Aramco Cybersecurity Compliance service provides expert guidance through the entire compliance journey, from initial assessment to implementation of required controls, helping organizations meet Saudi Aramco's cybersecurity standards and qualify as approved vendors."
      steps={[
        {
          title: "Saudi Aramco Requirements Assessment",
          description: "Comprehensive evaluation of your current security controls against Saudi Aramco's cybersecurity requirements to identify compliance gaps and priorities."
        },
        {
          title: "Security Risk Assessment",
          description: "Thorough assessment of cybersecurity risks specific to your organization in alignment with Saudi Aramco's risk assessment methodology."
        },
        {
          title: "Compliance Program Development",
          description: "Creation of a structured compliance program with clear policies, procedures, and controls tailored to your organization and Saudi Aramco's requirements."
        },
        {
          title: "Security Controls Implementation",
          description: "Implementation and enhancement of security controls to address identified gaps and achieve compliance with Saudi Aramco's requirements."
        },
        {
          title: "Vendor Management Framework",
          description: "Development of robust subcontractor and vendor management processes in line with Saudi Aramco's supply chain security requirements."
        },
        {
          title: "Compliance Documentation",
          description: "Preparation of comprehensive documentation required for Saudi Aramco's vendor qualification and cybersecurity assessment processes."
        },
        {
          title: "Pre-Audit Assessment",
          description: "Thorough evaluation of your readiness for Saudi Aramco's cybersecurity audit or assessment with remediation of identified issues."
        }
      ]}
      benefits={[
        {
          title: "Saudi Aramco Qualification",
          content: "Successfully qualify as a Saudi Aramco vendor or supplier by meeting their stringent cybersecurity requirements."
        },
        {
          title: "Enhanced Security Posture",
          content: "Implement robust security controls that protect your systems and data from advanced cybersecurity threats."
        },
        {
          title: "Competitive Advantage",
          content: "Differentiate your organization in the Saudi Arabian market through demonstrated commitment to high security standards."
        },
        {
          title: "Business Continuity",
          content: "Maintain business relationships with Saudi Aramco by ensuring ongoing compliance with their security requirements."
        },
        {
          title: "Risk Reduction",
          content: "Significantly reduce security risks that could impact your operations and partnership with Saudi Aramco."
        }
      ]}
      deliverables={[
        {
          title: "Gap Assessment Report",
          description: "Detailed analysis of your current compliance status with prioritized recommendations for addressing identified gaps against Saudi Aramco requirements."
        },
        {
          title: "Security Risk Register",
          description: "Comprehensive inventory of cybersecurity risks with clear mitigation strategies aligned with Saudi Aramco expectations."
        },
        {
          title: "Security Policies & Procedures",
          description: "Comprehensive set of policies and procedures aligned with Saudi Aramco's cybersecurity requirements."
        },
        {
          title: "Security Controls Documentation",
          description: "Detailed documentation of implemented security controls mapped to Saudi Aramco requirements."
        },
        {
          title: "Incident Response Plan",
          description: "Clear procedures for detecting, investigating, and reporting cybersecurity incidents in accordance with Saudi Aramco requirements."
        },
        {
          title: "Vendor Qualification Package",
          description: "Complete documentation package required for Saudi Aramco's vendor cybersecurity qualification process."
        }
      ]}
      animationSvg={
