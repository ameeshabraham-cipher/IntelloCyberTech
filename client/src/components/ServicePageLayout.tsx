...
interface ServicePageProps {
  ...
  overview: string;
  steps: ServiceStepProps[];
  benefits: ServiceBenefitProps[];
    ...
    <div className="min-h-screen pt-24">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-2 lg:order-1 reveal">
              <div className="inline-block bg-card/50 backdrop-blur px-4 py-2 rounded-full border border-[hsl(var(--secondary))]/20 mb-4">
                <span className="text-[hsl(var(--secondary))] font-medium">Service Overview</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-montserrat font-bold mb-6">
                How We <span className="text-transparent bg-clip-text bg-gradient-to-r from-[hsl(var(--primary))] to-[hsl(var(--secondary))]">Help</span>
              </h2>
              <p className="text-muted-foreground text-lg mb-8">
                {overview}
              </p>
                ...
                <div className="relative bg-card/50 backdrop-blur-sm p-8 rounded-2xl border border-[hsl(var(--secondary))]/20">
                  ...
                  <div className="absolute -top-5 right-10 bg-card border border-[hsl(var(--secondary))]/20 py-2 px-4 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <p className="text-xs">Expert Guidance</p>
                    </div>
                  </div>
                  ...
                  <div className="absolute -bottom-5 left-10 bg-card border border-[hsl(var(--secondary))]/20 py-2 px-4 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <p className="text-xs">Tailored Approach</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-background relative">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 reveal">
            ...
            <h2 className="text-3xl md:text-4xl font-montserrat font-bold mb-6">
              The <span className="text-transparent bg-clip-text bg-gradient-to-r from-[hsl(var(--primary))] to-[hsl(var(--secondary))]">Process</span>
            </h2>
            <p className="text-muted-foreground text-lg">
              Our structured methodology ensures comprehensive coverage and successful implementation.
            </p>
          </div>
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="flex items-start">
                  <div className="bg-background/50 w-10 h-10 rounded-full flex items-center justify-center text-[hsl(var(--secondary))] mr-4 mt-1 shrink-0">
      ...
      <section className="py-20 animated-gradient relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 reveal">
            ...
            <p className="text-muted-foreground text-lg">
              Our service delivers tangible advantages that help your organization achieve better security and compliance outcomes.
            </p>
          </div>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 reveal">
            <div className="inline-block bg-card/50 backdrop-blur px-4 py-2 rounded-full border border-[hsl(var(--secondary))]/20 mb-4">
              <span className="text-[hsl(var(--secondary))] font-medium">What You Get</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-montserrat font-bold mb-6">
              Service <span className="text-transparent bg-clip-text bg-gradient-to-r from-[hsl(var(--primary))] to-[hsl(var(--secondary))]">Deliverables</span>
            </h2>
            <p className="text-muted-foreground text-lg">
              Tangible outputs and documentation you receive as part of our service.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {deliverables.map((deliverable, index) => (
              <div 
                key={index} 
                className="bg-background/50 backdrop-blur-sm p-6 rounded-xl border border-[hsl(var(--secondary))]/10 reveal" 
                data-delay={index * 100}
              >
                <div className="flex mb-4">
                  <CheckCircle className="text-[hsl(var(--secondary))] h-6 w-6 shrink-0 mr-3" />
                  <h3 className="text-lg font-montserrat font-semibold">{deliverable.title}</h3>
                </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 reveal">
            ...
            <p className="text-muted-foreground text-lg">
              Discover our other services that complement this offering and provide comprehensive protection.
            </p>
          </div>
