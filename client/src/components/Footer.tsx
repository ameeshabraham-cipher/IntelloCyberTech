      ...
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">123 Business Bay, Dubai, UAE</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-muted-foreground">info@intellocyber.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-[hsl(var(--secondary))]/10 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Intello Cyber Technologies. All rights reserved.
          </p>
