  ...
  return (
    ...
    >
      <div className="flex items-center p-3">
        ...
        <span className={`ml-2 font-medium ${isHovered ? 'md:inline' : 'hidden md:inline'}`}>
          Chat on WhatsApp
        </span>
      </div>
      {/* Phone number badge */}
      <div className="absolute -top-2 -right-2 bg-white text-green-600 text-xs px-2 py-1 rounded-full font-bold shadow-sm">
        +971553556787
      </div>
    </a>
  );
